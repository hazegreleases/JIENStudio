...
class ProjectView(tk.Frame):
    ...
    def _create_ui(self):
        ...
        tk.Label(header_frame, text="JIET Studio Hub", 
    ...
    def _create_project_item(self, parent, path):
        item_frame = tk.Frame(parent, bg="#2d2d2d", pady=5, padx=5) # Darker bg for item
        ...
        tk.Label(info_frame, text=name, font=("Segoe UI", 11, "bold"), bg="#2d2d2d", fg="white").pack(anchor=tk.W)
        tk.Label(info_frame, text=path, font=("Segoe UI", 9), bg="#2d2d2d", fg="#aaa").pack(anchor=tk.W)
        
        btn_frame = tk.Frame(item_frame, bg="#2d2d2d")
